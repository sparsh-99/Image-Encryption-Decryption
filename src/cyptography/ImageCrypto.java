...
public class ImageCrypto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome to Image Cryptography using Blowfish Algorithm");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(file_path, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            FileOutputStream output = new FileOutputStream("Encrypted_image.jpg");
            ...
            output.flush();
            cos.close();
            JOptionPane.showMessageDialog(null, "The file is encrypted Successfully");
        }
        catch(Exception e){
...
file_path.setText(f.getAbsolutePath());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            FileInputStream file = new FileInputStream(file_path.getText());
            FileOutputStream output = new FileOutputStream("Decrypted_image.jpg");
            KeyGenerator keygen = KeyGenerator.getInstance("Blowfish");            //Created key generator based upon Blowfish cipher
            byte k[]="CooL2116NiTh5252".getBytes();
            SecretKeySpec key = new SecretKeySpec(k, "Blowfish");                           // Created a key
            Cipher cip = Cipher.getInstance("Blowfish");                           // Created a cipher based upon blowfish
            ...
            output.flush();
            cos.close();
            JOptionPane.showMessageDialog(null, "The file is decrypted Successfully");
        }
        catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
        }
